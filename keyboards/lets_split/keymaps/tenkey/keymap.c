...
/* Qwerty
 * ,-----------------------------------------.  ,-----------------------------------------.
 * |  F4  |  F8  |  F12 |   9  |   6  |   3  |  |   Y  |   U  |   I  |   O  |   P  | Bksp |
 * |------+------+------+------+------+------|  |------+------+------+------+------+------|
 * |  F3  |  F7  |  F11 |   8  |   5  |   2  |  |   H  |   J  |   K  |   L  |   ;  | ENT  |
 * |------+------+------+------+------+------|  |------+------+------+------+------+------|
 * |  F2  |  F6  |  F10 |   7  |   4  |   1  |  |   N  |   M  |   ,  |   .  |   '  | ESC  |
 * |------+------+------+------+------+------|  |------+------+------+------+------+------|
 * |  F1  |  F5  |  F9  |      |      |   0  |  |Space |  GUI |   -  |   =  |   /  |LOWER |
 * `-----------------------------------------'  `-----------------------------------------'
 */
[_QWERTY] = LAYOUT( \
  KC_F4,   KC_F8,   KC_F12,  KC_9,    KC_6,    KC_3,    KC_Y,    KC_U,    KC_I,    KC_O,    KC_P,    KC_BSPC, \
  KC_F3,   KC_F7,   KC_F11,  KC_8,    KC_5,    KC_2,    KC_H,    KC_J,    KC_K,    KC_L,    KC_SCLN, KC_ENT, \
  KC_F2,   KC_F6,   KC_F10,  KC_7,    KC_4,    KC_1,    KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_QUOT, KC_ESC , \
  KC_F1,   KC_F5,   KC_F9,   KC_TAB,  KC_ENT,  KC_0,    KC_SPC,  KC_RGUI, KC_MINS, KC_EQL,  KC_SLSH, LOWER \
),
