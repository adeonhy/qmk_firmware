...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
   ...
   * |------+------+------+------+------+------+-------------+------+------+------+------+------+------|
   * | Ctrl |Adjust| Alt  | GUI  | EISU |Lower |Space |Space |Raise | KANA |   /  | LEFT | DOWN |Right |
   * `-------------------------------------------------------------------------------------------------'
   */
...
[_QWERTY] = LAYOUT( \
      ...
      KC_LCTL, ADJUST,  KC_LGUI, KC_LALT, KC_ZKHK, LOWER,   KC_SPC,  KC_SPC,  RAISE,   KC_ZKHK, KC_SLSH, KC_LEFT, KC_DOWN, KC_RGHT \
      ),
  /* Colemak
   * ,-----------------------------------------.             ,-----------------------------------------.
   ...
   */
  [_LOWER] = LAYOUT( \
      KC_TILD, KC_EXLM, KC_LBRC,   KC_HASH, KC_DLR,  KC_PERC,                   KC_CIRC, KC_AMPR, KC_ASTR, KC_LPRN, KC_RPRN, KC_DEL, \
