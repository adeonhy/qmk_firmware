 ...
 * |------+------+------+------+------+------+------|   |-------------+------+------+------+------+------|
 * | Del  | LCtrl|   A  |   S  |   D  |   F  |  G   |   |  H   |   J  |   K  |   L  |   ;  |   '  | Enter|
 * |------+------+------+------+------+------+------|   |------|------+------+------+------+------+------|
 * | SYMB | LSft |   Z  |   X  |   C  |   V  |  B   |   |  N   |   M  |   ,  |   .  |   /  |   \  | ESC  |
 * |------+------+------+------+------+------+------|   |------+------+------+------+------+------+------|
 * | LEFT | UP   | META |  ESC | LAlt | LGUI |Space |   |Space | RGUI | DOWN | RIGHT|   `  |   -  |   =  |
 * `------------------------------------------------'   `------------------------------------------------'
 */

[BASE] = KEYMAP( \
  KC_ESC,   KC_TAB,  KC_Q,     KC_W,   KC_E,    KC_R,    KC_T,   KC_Y,   KC_U,    KC_I,    KC_O,   KC_P,    KC_LBRC, KC_BSPC, \
  KC_DELT,  KC_LCTL, KC_A,     KC_S,   KC_D,    KC_F,    KC_G,   KC_H,   KC_J,    KC_K,    KC_L,   KC_SCLN, KC_QUOT, KC_ENT, \
  MO(SYMB), KC_LSFT, KC_Z,     KC_X,   KC_C,    KC_V,    KC_B,   KC_N,   KC_M,    KC_COMM, KC_DOT, KC_SLSH, KC_BSLS, KC_ESC, \
  KC_LEFT,  KC_UP,   MO(META), MO(SYMB), KC_LALT, KC_LGUI, KC_SPC, KC_SPC, KC_RGUI, KC_DOWN, KC_RGHT,KC_GRV,  KC_MINS, KC_EQL \
),
