 ...
 * |------+------+------+------+------+------+------|   |------+------+------+------+------+------+------|
 * | [    |  ]   | META |  ESC | LAlt | LGUI |Space |   |Space | RGUI | ESC  |      |   `  |   -  |   =  |
 * `------------------------------------------------'   `------------------------------------------------'
 */
...
[BASE] = KEYMAP( \
  ...
  KC_LBRC,  KC_RBRC, MO(META), MO(SYMB), KC_LALT, KC_LGUI, LT(SYMB, KC_SPC), LT(META, KC_SPC), KC_RGUI, KC_ESC, KC_RGHT,KC_GRV,  KC_MINS, KC_EQL \
),
...
[SYMB] = KEYMAP( \
  ...
  _______, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX,    KC_LEFT, KC_DOWN, KC_UP,   KC_RGHT, XXXXXXX, XXXXXXX, _______, \
