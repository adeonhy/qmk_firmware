 ...
 * |------+------+------+------+------+------+------|   |------+------+------+------+------+------+------|
 * | META | SYMB |  App |PrtSc |ESC/  |Space/|Tab/  |   |Back  |Enter/| Del  |PrtSc |=>GAME|=>SYMB|  \   |
...
[BASE] = KEYMAP( \
  ...
  KC_LCTRL, KC_A,    KC_S,   KC_D,    KC_F,             KC_G,          S(KC_8),       KC_H,       KC_J,    KC_K,    KC_L,    KC_SCLN,  KC_QUOT,  KC_ENT, \
  KC_LSFT,  KC_Z,    KC_X,   KC_C,    KC_V,             KC_B,          S(KC_RBRC),    S(KC_BSLS), KC_N,             KC_M,    KC_COMM,  KC_DOT,   KC_SLSH,  SFT_T(KC_RO), \
  META,     KC_LGUI, KC_APP, KC_PSCR, LT(SYMB, KC_ESC), GUI_T(KC_SPC), SFT_T(KC_TAB), KC_BSPC,    LT(META, KC_ENT), KC_DELT, KC_PSCR,  TG(GAME), TG(SYMB), KC_JYEN \
),
