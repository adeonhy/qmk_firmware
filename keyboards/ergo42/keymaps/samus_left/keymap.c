 ...
 * | Sft  |   Z  |   X  |   C  |   V  |   B  |  [   |   |  ]   |   N  |   M  |   ,  |   .  |   /  |  \   |
 * |------+------+------+------+------+------+------|   |------+------+------+------+------+------+------|
 * |  =   |  -   |  `   |LALT  |LGUI/ |Space/|Enter |   |Back  |Space/| RGUI | ESC/ | Copy | Paste| Enter|
 * |      |      |      |      |      |SYMB  |      |   |Space |META  |      | Alt  |      |      |      |
 * `------------------------------------------------'   `------------------------------------------------'
 */
...
[BASE] = KEYMAP( \
  ...
  KC_EQL,   KC_MINS, KC_GRV, KC_LALT, KC_LGUI, LT(SYMB, KC_SPC), KC_ENT,        KC_BSPC,    LT(META, KC_SPC), KC_ESC,  KC_RGUI,  LGUI(KC_C), LGUI(KC_V), KC_ENT \
),
