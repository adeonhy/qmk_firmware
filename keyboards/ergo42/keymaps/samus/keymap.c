 ...
 * | Sft  |   Z  |   X  |   C  |   V  |   B  |  [   |   |  ]   |   N  |   M  |   ,  |   .  |   /  |  \   |
 * |------+------+------+------+------+------+------|   |------+------+------+------+------+------+------|
 * |=/NUM |  `   |  `   |LALT  |LGUI/ |Space/|Enter |   |Back  |Space/| RGUI | ESC/ | Copy | Paste| Enter|
 * |      |      |      |      |      |SYMB  |      |   |Space |META  |      | Alt  |      |      |      |
 * `------------------------------------------------'   `------------------------------------------------'
 */
...
[BASE] = KEYMAP( \
  ...
  LT(NUM, KC_EQL),   KC_GRV, KC_GRV, KC_LALT, KC_LGUI, LT(SYMB, KC_SPC), KC_ENT,        KC_BSPC,    LT(META, KC_SPC), KC_ESC,  KC_RGUI,  LGUI(KC_C), LGUI(KC_V), LALT_T(KC_ENT) \
),
