 ...
 * | Sft  |   Z  |   X  |   C  |   V  |   B  |  [   |   |  ]   |   N  |   M  |   ,  |   .  |   /  |  \   |
 * |------+------+------+------+------+------+------|   |------+------+------+------+------+------+------|
 * |      |      |      |LALT  |LGUI/ |Space/|Enter |   |Back  |Space/| RGUI | ESC/ | `    |  -   |  =   |
 * |      |      |      |      |      |SYMB  |      |   |Space |META  |      | Alt  |      |      |      |
 * `------------------------------------------------'   `------------------------------------------------'
 */
...
[BASE] = KEYMAP( \
  ...
  XXXXXXX,  XXXXXXX, XXXXXXX,KC_LALT, KC_LGUI, LT(SYMB, KC_SPC), KC_ENT,        KC_BSPC,    LT(META, KC_SPC), KC_ESC,  KC_RGUI,  KC_GRV,   KC_MINS,  KC_EQL \
),
