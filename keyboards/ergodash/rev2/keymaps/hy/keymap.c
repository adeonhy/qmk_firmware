...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
   ...
   * |-------------+------+------+------+------+------+------+------+------+------+------+------+------+------+-------------|
   * |  =   |  GUI |  ALt |Adjust|||||||| Lower| Space| Enter|||||||| Bksp | Enter| Raise|||||||| Left | Down |  Up  | Right|
   * ,----------------------------------------------------------------------------------------------------------------------.
   */
  [_QWERTY] = LAYOUT( \
    ...
    KC_LSFT, KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,    KC_JPN ,                        KC_ESC , KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH, KC_RSFT, \
    KC_EQL, KC_GRV, KC_LALT, KC_C,           KC_L,   LT(SYMB, KC_SPC), KC_ENT,        KC_BKSP ,LT(META, KC_SPC), KC_R,            KC_LEFT, KC_DOWN, KC_UP,   KC_RGHT  \
  ),
